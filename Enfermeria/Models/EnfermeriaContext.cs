...
//        => optionsBuilder.UseSqlServer("server=localhost; database=enfermeria; User Id=sa;Password=Infomaniacos2025!; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<EnfCita>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__enf_cita__3213E83FD147CF3E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__enf_hora__3213E83F51C162E5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__enf_pers__3213E83F66577561");

            entity.ToTable("enf_personas");

            entity.HasIndex(e => e.Cedula, "UQ__enf_pers__415B7BE5E6660F4A").IsUnique();

            entity.HasIndex(e => e.Usuario, "UQ__enf_pers__9AFF8FC6FEAFC9F7").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__enf_pers__AB6E6164C7166B98").IsUnique();
